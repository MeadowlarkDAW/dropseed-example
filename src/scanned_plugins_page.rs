...
pub(crate) fn show(app: &mut BasicDawExampleGUI, ui: &mut egui::Ui) {
    ...
    if ui.button("Rescan all plugin directories").clicked() {
        app.engine_handle
            .send(DSEngineRequest::RescanPluginDirectories);
    }
    ...
    egui::ScrollArea::vertical().show(ui, |ui| {
        ...
        egui::ScrollArea::horizontal()
            .id_source("available_plugs_hscroll")
            .show(ui, |ui| {
                egui::Grid::new("available_plugs")
                    .num_columns(10)
                    .striped(true)
                    .show(ui, |ui| {
                        ui.label("NAME");
        ...
        egui::ScrollArea::horizontal()
            .id_source("failed_plugs_hscroll")
            .show(ui, |ui| {
                egui::Grid::new("failed_plugs")
                    .num_columns(2)
                    .striped(true)
                    .show(ui, |ui| {
                        ui.label("PATH");
